...
type message struct {
	...
	RunID            field.Int64  // Corresponding run_id
	...
	MessageType      field.String // Message type:
	DisplayContent   field.String // display content
	Ext              field.String // message extension field
	SectionID        field.Int64  // Paragraph ID
	BrokenPosition   field.Int32  // interrupt position
	Status           field.Int32  // Message Status 1 Available 2 Deleted 3 Replaced 4 Broken 5 Failed 6 Streaming 7 Pending
	ModelContent     field.String // model input
	MetaInfo         field.String // Text markup information such as quotes and highlights
	ReasoningContent field.String // Think content
