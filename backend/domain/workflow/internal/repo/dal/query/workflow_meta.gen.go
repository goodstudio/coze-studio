...
type workflowMeta struct {
	...
	Status          field.Int32  // 0: Unpublished, 1: Published
	...
	UpdaterID       field.Int64  //  User ID for updating meta information
	SourceID        field.Int64  //  Copy the workflow ID of the source
