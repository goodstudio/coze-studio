...
// WorkflowMeta workflow meta information table, used to record the basic meta information of workflow
type WorkflowMeta struct {
	...
	Status          int32          `gorm:"column:status;not null;comment:0:未发布过, 1:已发布过" json:"status"`                                                                                                                                                                                                             // 0: Unpublished, 1: Published
	ContentType     int32          `gorm:"column:content_type;not null;comment:0用户 1官方" json:"content_type"`                                                                                                                                                                                                        // 0 users 1 official
	...
	AuthorID        int64          `gorm:"column:author_id;not null;comment:原作者用户 ID" json:"author_id"`                                                                                                                                                                                                             // original author user ID
	SpaceID         int64          `gorm:"column:space_id;not null;comment: 空间 ID" json:"space_id"`                                                                                                                                                                                                                 //  Space ID
	UpdaterID       int64          `gorm:"column:updater_id;comment: 更新元信息的用户 ID" json:"updater_id"`                                                                                                                                                                                                                //  User ID for updating meta information
	SourceID        int64          `gorm:"column:source_id;comment: 复制来源的 workflow ID" json:"source_id"`                                                                                                                                                                                                            //  Copy the workflow ID of the source
	AppID           int64          `gorm:"column:app_id;comment:应用 ID" json:"app_id"`                                                                                                                                                                                                                               // App ID
