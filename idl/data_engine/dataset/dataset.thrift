...
struct CreateDatasetRequest  {
    ...
    7: i64 project_id (agw.js_conv="str", api.js_conv="true") //Add project ID
...
struct DatasetDetailRequest {
    ...
    3: i64 project_id (agw.js_conv="str", api.js_conv="true") //Add project ID
...
struct Dataset {
    ...
    13: i32           create_time          // Creation time, second timestamp
    ...
    25: string        project_id          //Add project ID
}
...
struct ListDatasetRequest {
    ...
    7: optional common.OrderType   order_type   // collation
    ...
    11: optional string project_id //Add project ID
    255: optional base.Base Base
}
...
struct DatasetFilter {
    ...
    2: optional list<string>  dataset_ids (agw.js_conv="str") // Knowledge base id list
