...
struct DocumentInfo {
    ...
    5:  i32                create_time     // creation time
    6:  i32                update_time     // update time
    7:  optional i64    creator_id (agw.js_conv="str", api.js_conv='true', api.body="creator_id")      // founder
    ...
    12: common.DocumentStatus status       // state
...
struct ListPhotoRequest {
    1: required i64  dataset_id(agw.js_conv='str', api.js_conv='true') // Knowledge Base ID
...
struct PhotoFilter {
    ...
    3: optional common.DocumentStatus status // state
}
...
struct PhotoInfo { // Picture Knowledge Base One picture corresponds to one document
    ...
    5:  i32                create_time     // creation time
    6:  i32                update_time     // update time
    7:  i64                creator_id (agw.js_conv="str", api.js_conv='true', agw.key="creator_id", api.body="creator_id")      // founder
    8:  string             type            // Image suffix jpg, png, etc
    9: i32                size            // image size
    10: common.DocumentStatus status       // state
...
struct PhotoDetailRequest {
    ...
    2: required i64        dataset_id(agw.js_conv='str', api.js_conv='true') // Knowledge Base ID
    255: optional base.Base Base
}
...
struct ResegmentRequest {
    1: i64 dataset_id (agw.js_conv="str", api.js_conv="true") // Knowledge Base ID
