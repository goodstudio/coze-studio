...
enum ActionKey{
    ...
    CrossSpaceCopy = 10, // Cross-spatial replication
}

enum ProjectResourceActionKey{
    Rename    = 1,        //rename
    Copy  = 2,        //Create a copy/copy to the current project
    CopyToLibrary = 3,   //Copy to repository
...
enum ResourceCopyScene {
    ...
    CrossSpaceCopy    = 12,        // Cross-spatial replication of a single resource
    CrossSpaceCopyProject = 13,        // item cross-spatial replication
}
...
struct ResourceCopyTaskDetail{
    ...
    6: optional string res_name, // Resource name before replication
}
