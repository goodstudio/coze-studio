...
struct KnowledgeInfo {
    1: optional string Id   (api.body="id")  , // Knowledge Base ID
...
struct BotInfo {
    ...
    7 : i64                CreateTime       (agw.js_conv="str", api.js_conv="true", api.body="create_time") , // creation time
...
struct OpenAPIBotInfo {
    ...
    5 : i64 create_time,                              // creation time
...
struct BotInfoForUpdate {
    ...
    7:  optional i64 CreateTime (agw.js_conv="str", api.js_conv="true", api.body="create_time")                             // creation time
...
struct TaskInfoDetail {                          // Tasks Detail
    ...
    3: optional string CreateTime                // Timed task creation time
...
//     7: string CreatedAt (api.body = "created_at")//creation time
